package com.szy.o2o.util.wechat;
...
public class WechatUtil {
	...
	public static UserAccessToken getUserAccessToken(String code) throws IOException {
		// 测试号信息里的appId
		String appId = "wx97dfa48985356988";
		log.debug("appId:" + appId);
		// 测试号信息里的appsecret
		String appsecret = "7b1b7077b456fe3fb290f9f5f103cdfb";
	 ...
	 * @return
	 */
	public static UserAccessToken getUserInfo(String accessToken, String openId) {
		...
		ObjectMapper objectMapper = new ObjectMapper();
		try {
			// 将json字符串转换成相应对象WechatUser
			user = objectMapper.readValue(userStr, UserAccessToken.class);
		} catch (JsonParseException e) {
