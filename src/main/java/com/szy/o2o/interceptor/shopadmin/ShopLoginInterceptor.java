package com.szy.o2o.interceptor.shopadmin;
...
/**
 * 
 * ClassName: ShopLoginInterceptor <br/>  
 * Function: 店家管理系统登录验证拦截器 <br/>  
 * date: 2018年5月9日 下午8:45:29 <br/>  
 *  
 * @author sunzhenyang  
 * @version 1.0   
 * @since JDK 1.8
...
public class ShopLoginInterceptor extends HandlerInterceptorAdapter{
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if(userObj!=null){
			...
			if(user!=null && user.getUserId() != null && user.getUserId() > 0 && user.getEnableStaus() == 1)
